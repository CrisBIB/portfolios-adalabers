...
const buttonElement = document.querySelector(".js-buttonPrev");

const hadleButton = (ev) => {
  const adaCard = getUserData();
  ev.preventDefault();
  sendCard(adaCard);
  console.log(adaCard);
  /* const url = "https://awesome-portfolio-adalabers.com/card";
...
buttonElement.addEventListener("click", hadleButton);
